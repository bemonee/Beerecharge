...
{block name="section_title"}
    <div class="float-left">
        <i class="fa fa-product-hunt fa-fw" aria-hidden="true"></i> Modificación de Producto
    </div>
...
{block name="section"}
    <div class="row">
        <div class="col-6">
            <form action="{$p_dir}/productos/update/{$id}/" method="POST" enctype="multipart/form-data">
                ...
                <div class="md-form form-sm">
                    ...
                    <input type="number" step="0.01" min="0" id="capacidad_lts" name="capacidad_lts" class="form-control" value="{$capacidad_lts}">
                    <label for="capacidad_lts">Capacidad en Lts (##,##)</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-money prefix"></i>
                    <input type="number" step="0.01" min="0" max="1" id="factor_precio" name="factor_precio" class="form-control" value="{$factor_precio}">
