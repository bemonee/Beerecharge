...
{block name="section_title"}
    <div class="float-left">
        <i class="fa fa-beer fa-fw" aria-hidden="true"></i> Modificar Cerveza
    </div>
...
{block name="section"}
    <div class="row">
        <div class="col-6">
            <form action="{$p_dir}/cervezas/update/{$id}/" method="POST" enctype="multipart/form-data">
                ...
                <div class="md-form form-sm">
                    ...
                    <input type="number" step="0.01" min="0" max="99.99" id="abv" name="abv" class="form-control" value="{$abv}">
                    <label for="abv">ABV (##,##)</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-hashtag prefix"></i>
                    <input type="number" step="1" min="0" max="99" id="ibu" name="ibu" class="form-control" value="{$ibu}">
                    <label for="ibu">IBU (##)</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-hashtag prefix"></i>
                    <input type="number" step="1" min="0" max="99" id="srm" name="srm" class="form-control" value="{$srm}">
                    <label for="srm">SRM (##)</label>
                </div>
                <div class="md-form form-sm">
                    <i class="fa fa-money prefix"></i>
                    <input type="number" step="0.01" min="0" max="9999.99" id="precio_x_litro" name="precio_x_litro" class="form-control" value="{$precio_x_litro}">
